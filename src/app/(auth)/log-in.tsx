...
import { View, Text, ActivityIndicator, ViewStyle, Pressable, ScrollView, Alert } from 'react-native'
      ...
      <View style={FormStyles.container}>
        ...
        <View style={FormStyles.form}>
          ...
          <View style={FormStyles.inputContainer}>
            ...
            <Pressable>
              <Text style={FormStyles.captionRight}> Forgot Password? </Text>
            </Pressable>
          </View>
          {loading ? (
            ...
            <>
              <Button text='Log In' onPress={handleSubmit(authLogIn as SubmitHandler<FieldValues>)} />
            </>
          )}
        </View>
        ...
        <View style={FormStyles.footer}>
          ...
          <View style={FormStyles.rowFix}>
            <Text style={FormStyles.footerText}>Don't have an account? </Text>
            <Link href={'/sign-up'}>
